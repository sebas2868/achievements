...
class MinimalSubscriber : public rclcpp::Node
{
    ...
    private:
        ...
        void timer_callback()
        {
            ...
            pos_error = pos_error*(3<pos_error) + 3*(3>pos_error)*(0.5<pos_error);
            ...
            neuron_[0][1] = std::max((neuron_[0][0] + (1 / tau1) * (-neuron_[0][0] + neuron_[5][0] + neuron_[14][0] - neuron_[1][0] * 4 - neuron_[2][0] * 4 - 100 * neuron_[3][0] - neuron_[19][0] - neuron_[13][0] * 10 - neuron_[12][0] * 10)), 0.0); //neurona central
            ...
            neuron_[14][1] = std::max((neuron_[14][0] + (1.0 / tau1) * (-neuron_[14][0] - neuron_[11][0] * 100 + pos_error * 0.3 )), (double)0.0); //retorno

            neuron_[15][1] = std::max((neuron_[15][0] + (1.0 / tau1) * (-neuron_[15][0] + 1 / (pos_error + 0.001) - 2.5)), (double)0.0); //deterner el regreso
            ...
            // RCLCPP_INFO(this->get_logger(), "giro: %f",   j);
            // RCLCPP_INFO(this->get_logger(), "giro_2: %f",   neuron_[8][0]);
