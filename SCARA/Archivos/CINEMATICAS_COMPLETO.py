...
rho = 0.223
theta = 120*np.pi/180
X_prueba = rho*np.cos(theta)#np.linspace(0.1, 0.3, 100)
Y_prueba = rho*np.sin(theta)#np.linspace(0.1, 0.3, 100)
# Punto de prueba
#X_prueba, Y_prueba = 0.3645, 0.0
m = int(input("Método Numérico\n[1] Newton\n[2] Gradiente\nSelección: "))
...
q1_NUMGRAD, q2_NUMGRAD = hallar_angulos_NUM(X_prueba, Y_prueba,m)
